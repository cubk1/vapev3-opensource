...
public class Search extends Mod {
   ...
   public Search() {
      super("Search", -16737793, Category.None, "Draws outline around selected blocks\nAdd blocks in Search frame");
      this.addValue(this.c2992, this.c2905);
   ...
   // $FF: synthetic method
   public static SearchProcessor c575(Search var0) {
      return var0.c1917;
   }

   // $FF: synthetic method
   public static BooleanValue c8842(Search var0) {
      return var0.c2905;
   }

   // $FF: synthetic method
   public static SearchProcessor c4560(Search var0) {
      return var0.c4843;
   }
}
